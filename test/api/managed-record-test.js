import retrieve from '../../api/managed-records.mjs';
	...
	describe('should return results for', function () {
		...
		it('fifteenth page with colors', function (done) {
			var expected = {
				...
				open: [
					{ id: 240, color: 'blue', disposition: 'open', isPrimary: true },
					{ id: 241, color: 'red', disposition: 'open', isPrimary: true },
					{ id: 243, color: 'blue', disposition: 'open', isPrimary: true },
					{ id: 251, color: 'blue', disposition: 'open', isPrimary: true },
					{ id: 252, color: 'blue', disposition: 'open', isPrimary: true },
					{ id: 256, color: 'red', disposition: 'open', isPrimary: true },
				],
		...
		it('thirty fourth page', function (done) {
			var expected = {
				...
				open: [
					{ id: 332, color: 'brown', disposition: 'open', isPrimary: false },
					{ id: 334, color: 'green', disposition: 'open', isPrimary: false },
					{ id: 336, color: 'blue', disposition: 'open', isPrimary: true },
					{ id: 337, color: 'green', disposition: 'open', isPrimary: false },
					{ id: 339, color: 'green', disposition: 'open', isPrimary: false },
					{ id: 340, color: 'red', disposition: 'open', isPrimary: true },
				],
		...
		it('last page', function (done) {
			var expected = {
				...
				open: [{ id: 491, color: 'red', disposition: 'open', isPrimary: true }],
				closedPrimaryCount: 6,
			};
			retrieve({ page: 50 })
				.then(function (output) {
					expect(output).toEqual(expected);
